...
<div class="container">
  ...
  <input type="text" class="form-control" id="exhibit_name" name="exhibit_name" required value="{{$exhibit->exhibit_name}}">
  ...
  <input type="text" class="form-control" id="exhibit_artist" name="exhibit_artist" required value="{{$exhibit->artist}}">

  <label for="exhibit_url" class="font-weight-bold mt-4">Exhibit URL</label>
  <textarea type="text" class="form-control" id="exhibit_url" name="exhibit_url" required value="">{{$exhibit->url}}</textarea>
